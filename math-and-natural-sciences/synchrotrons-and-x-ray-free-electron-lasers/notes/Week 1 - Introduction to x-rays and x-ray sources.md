...
$$E[\mathrm{eV}] = \frac{12398.4}{\lambda} \; [\unicode{xC5}]$$
...
- The shortest bond length is of the $\mathrm{H}_2$ molecule: $0.74 \; \unicode{xC5}$;
  - Bonds between heavy elements can exceed $3 \; \unicode{xC5}$ ($4 \; \mathrm{keV}$);
